...
#include <Arcane/Physics/Broadphase/DynamicTree.hpp>     // DynamicTree::kMargin + TryGetFatBox (fat-box gates)
#include <Arcane/Physics/Narrowphase/GeometryKernel.hpp> // AabbOverlap
#include <Arcane/Physics/Narrowphase/Collide.hpp>        // Collide (fixture-pair narrowphase)
#include <Arcane/Physics/Shapes.hpp>                     // MakeAabb (tile-span virtual fixtures)
#include <Arcane/Physics/Island.hpp>                     // Island::kInvalidIsland (merge drain)
