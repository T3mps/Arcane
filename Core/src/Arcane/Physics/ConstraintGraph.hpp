...
#include <Arcane/Physics/PhysicsTypes.hpp>          // Real / Vec2 / BodyHandle / Aabb2
#include <Arcane/Physics/Contact.hpp>               // Contact + ContactPool + FixtureHandle
#include <Arcane/Physics/Broadphase/Broadphase.hpp> // BroadphasePair
#include <Arcane/Physics/Solver/Solver.hpp>         // ContactConstraint
#include <Arcane/Util/BitSet.hpp>                   // per-worker npState BitSets
