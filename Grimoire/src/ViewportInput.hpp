...
// they are unit-testable headlessly (see Tests/src/GrimoireViewportInputTest.cpp,
// source-compiled straight into ArcaneTests). Consumed by GrimoireApp to decide
