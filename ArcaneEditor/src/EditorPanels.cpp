...
namespace Arcane::Editor
{
    ...
    namespace
    {
        ...
        // and these two do the resolving. TEMPORARY HERE -- they move to
        // InspectorView with the rest of the Inspector in the next task.
        ...
        struct ImGuiFieldVisitor : Astra::IFieldVisitor
        {
            ...
            // EditorPanels.cpp:1372-1377). A Play-mode texture drop
