...
namespace Arcane::Editor
{
    ...
    {
        // Same name-fallback rule as ShaderEditorDocument (ShaderEditorDocument.cpp:544):
        ...
        // (ShaderEditorDocument.cpp:549 mints its own the same way).
    ...
    SpriteDocument::~SpriteDocument()
    {
        ...
        // (ShaderEditorDocument.cpp:578-599). Documents are destroyed
    ...
    void SpriteDocument::Draw(bool& requestClose)
    {
        ...
        if (!ImGui::Begin(m_windowLabel.c_str(), &open, flags))
        {
            ...
            // shape (ShaderEditorDocument.cpp:1262-1267) -- `open` only goes
        ...
        if (tex)
        {
            ...
            if (desc.width > 0 && desc.height > 0)
            {
                ...
                // (ShaderEditorDocument.cpp:1716,1736; the backend keys its
