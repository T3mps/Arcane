...
namespace Arcane::Editor
{
    ...
    {
        // Same name-fallback rule as ShaderEditorDocument (ShaderEditorDocument.cpp:871):
        ...
        // (ShaderEditorDocument.cpp:876 mints its own the same way).
    ...
    SpriteDocument::~SpriteDocument()
    {
        ...
        // (ShaderEditorDocument.cpp:905-926). Documents are destroyed
    ...
    void SpriteDocument::Draw(bool& requestClose)
    {
        ...
        if (!ImGui::Begin(m_windowLabel.c_str(), &open, flags))
        {
            ...
            // shape (ShaderEditorDocument.cpp:1617-1622) -- `open` only goes
        ...
        // ShaderEditorDocument.hpp:207-211; the sprite watcher path does not
        ...
        if (tex)
        {
            ...
            if (desc.width > 0 && desc.height > 0)
            {
                ...
                // (ShaderEditorDocument.cpp:2107,2127; the backend keys its
