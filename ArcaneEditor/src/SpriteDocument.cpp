...
namespace Arcane::Editor
{
    ...
    {
        // Same name-fallback rule as ShaderEditorDocument (ShaderEditorDocument.cpp:450):
        ...
        // (ShaderEditorDocument.cpp:455 mints its own the same way).
    ...
    SpriteDocument::~SpriteDocument()
    {
        ...
        // (ShaderEditorDocument.cpp:484-505). Documents are destroyed
    ...
    void SpriteDocument::Draw(bool& requestClose)
    {
        ...
        if (!ImGui::Begin(m_windowLabel.c_str(), &open, flags))
        {
            ...
            // shape (ShaderEditorDocument.cpp:1163-1168) -- `open` only goes
        ...
        if (tex)
        {
            ...
            if (desc.width > 0 && desc.height > 0)
            {
                ...
                // (ShaderEditorDocument.cpp:1611,1631; the backend keys its
